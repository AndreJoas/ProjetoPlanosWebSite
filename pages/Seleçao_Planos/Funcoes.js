...
// ------------- step 04
var a = document.getElementById('ret1');



var a = 0;
function moveDiv() {
    let divEmPrograsso = document.getElementById("ret1").innerHTMLd;
    // divEmPrograsso.appendChild(div.parentElement);
    document.getElementById("planos").appendChild(divEmPrograsso)
    console.log("foi")
}
